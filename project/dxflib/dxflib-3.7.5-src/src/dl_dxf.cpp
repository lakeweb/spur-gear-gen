...
void DL_Dxf::writeDimStyleOverrides(DL_WriterA& dw,
    ...
    if (version==DL_VERSION_2000) {
        ...
        dw.dxfString(1002, "{");
        dw.dxfInt(1070, 144);
        dw.dxfInt(1040, (int)data.linearFactor);
        dw.dxfString(1002, "}");
    }
}
...
void DL_Dxf::writeVPort(DL_WriterA& dw) {
    ...
    dw.dxfReal( 11, 1.0);
    dw.dxfReal( 21, 1.0);
    dw.dxfReal( 12, 4.41564193701 );
    dw.dxfReal( 22, 2.27592855622 );
    dw.dxfReal( 13, 0.0);
    dw.dxfReal( 23, 0.0);
    dw.dxfReal( 14, 10.0);
    dw.dxfReal( 24, 10.0);
...
{
	//11/3/15 DBQUEST why is this commented????????
	//ok, it looks like this 'was/is' going to be expanded for multiple STYLE
	//so this would write one style but not set up the TABLE. 
...
// end why..........................
	//the example must be way behind the times even if it ships with this lib....
	//use 	dw->tableStyle( 1 ) and dw->tableEnd( ) to bracket this call
