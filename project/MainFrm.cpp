...
//this is used to update the sattalite windows like layer, etc. from the main doc or view......
LRESULT CMainFrame::OnInfoNotify( WPARAM wp,LPARAM lp )
{
	info_notify_t* pNote= reinterpret_cast< info_notify_t* >( wp );
...
BOOL CMainFrame::CreateDockingWindows()
{
	...
	bNameValid = strClassView.LoadString(IDS_LAYER_VIEW);
	ASSERT(bNameValid);
	if (!layer_tree_view.Create(strClassView, this, CRect(0, 0, 200, 200), TRUE, ID_VIEW_CLASSVIEW, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_LEFT | CBRS_FLOAT_MULTI))
	{
